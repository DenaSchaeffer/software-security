...
.method public parse(Lcom/google/zxing/Result;)Lcom/google/zxing/client/result/EmailAddressParsedResult;
    ...
    .line 53
    :cond_2
    invoke-static {v12}, Lcom/google/zxing/client/result/EmailAddressResultParser;->parseNameValuePairs(Ljava/lang/String;)Ljava/util/Map;

    move-result-object v10

    .line 54
    .local v10, "nameValues":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    const/4 v2, 0x0
    ...
    .line 61
    .local v13, "tosString":Ljava/lang/String;
    if-eqz v13, :cond_3

    .line 62
    sget-object v0, Lcom/google/zxing/client/result/EmailAddressResultParser;->COMMA:Ljava/util/regex/Pattern;

    invoke-virtual {v0, v13}, Ljava/util/regex/Pattern;->split(Ljava/lang/CharSequence;)[Ljava/lang/String;

    move-result-object v1

    .line 65
    .end local v13    # "tosString":Ljava/lang/String;
    :cond_3
    const-string v0, "cc"
    ...
    .end local v10    # "nameValues":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v11    # "queryStart":I
    :goto_0
    return-object v0

    .line 46
    .restart local v8    # "hostEmail":Ljava/lang/String;
    .restart local v11    # "queryStart":I
    :catch_0
    move-exception v9
    ...
    .end local v11    # "queryStart":I
    :cond_7
    invoke-static {v12}, Lcom/google/zxing/client/result/EmailDoCoMoResultParser;->isBasicallyValidEmailAddress(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v12}, Lcom/google/zxing/client/result/EmailAddressParsedResult;-><init>(Ljava/lang/String;)V
