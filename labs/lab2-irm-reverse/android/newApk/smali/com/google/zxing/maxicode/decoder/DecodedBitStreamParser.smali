...
.method static decode([BI)Lcom/google/zxing/common/DecoderResult;
    ...
    invoke-direct {v7, p0, v8, v9, v10}, Lcom/google/zxing/common/DecoderResult;-><init>([BLjava/lang/String;Ljava/util/List;Ljava/lang/String;)V
    ...
    .line 87
    .local v6, "threeDigits":Ljava/text/NumberFormat;
    ...
    .end local v6    # "threeDigits":Ljava/text/NumberFormat;
    :cond_0
    ...
    .restart local v6    # "threeDigits":Ljava/text/NumberFormat;
    :cond_1
    ...
    invoke-virtual {v4, v11, v7}, Ljava/lang/StringBuilder;->insert(ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p0, v8, v7}, Lcom/google/zxing/maxicode/decoder/DecodedBitStreamParser;->getMessage([BII)Ljava/lang/String;
